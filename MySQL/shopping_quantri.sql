...
CREATE TABLE `quantri` (
  ...
  `TenQT` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `TaiKhoan` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `quantri` VALUES (1,'admin','admin','admin',NULL);
