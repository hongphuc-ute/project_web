...
CREATE TABLE `nhomsanpham` (
  `MaNhomSP` int NOT NULL AUTO_INCREMENT,
  `TenNhomSP` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `nhomsanpham` VALUES (1,'Apple',NULL),(2,'SamSung',NULL),(3,'Oppo',NULL);
